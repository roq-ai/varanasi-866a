  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover, Explore, and Navigate with VarANASI - Your Ultimate Guide to Unveiling the Secrets of Any City."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1594058573823-d8edf1ad3380?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxjaXR5fGVufDB8fHx8MTY5MDk4NDAxOXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover, Explore, and Navigate with VarANASI - Your Ultimate Guide to Unveiling the Secrets of Any City.`}
            </Text>
            <Box
