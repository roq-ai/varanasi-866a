...
import { getTourismById } from 'apiSdk/tourisms';
import { TourismInterface } from 'interfaces/tourism';

function TourismViewPage() {
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('tourism', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/tourisms/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="tourism" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
